...
const TRANSLATIONS = {
  de: {
    ...
    'ne.field.rule.desc':      'Beschreibung',
    ...
    'ne.adv.section':              'Erweitert',
    'ne.adv.valueType':            'Werttyp',
    ...
    'ne.node.note.label':      'Notiz',
    'ne.node.color':           'Farbe wechseln',
    'ne.placeholder.note':     'Kommentar eingeben…',
    'ne.search.placeholder':   'Suchen…',
    'ne.search.title':         'Node nach Name suchen',
    'ne.share.title':          'Teilbaren Link kopieren',
    'ne.minimap.title':        'Minimap — klicken zum Navigieren',
    'ne.tpl.btn':              'Vorlagen',
    'ne.tpl.btn.title':        'Vorgefertigte Policy-Vorlagen laden',
    'ne.tpl.modal.title':      'Policy-Vorlage wählen',
    'ne.tpl.modal.close':      'Schließen',
    'ne.tpl.load':             'Laden',
    'ne.tpl.confirm':          'Aktuellen Canvas durch Vorlage ersetzen?',
    'ne.tpl.adminOnly.title':  'Nur Admins dürfen alles',
    'ne.tpl.adminOnly.desc':   'Einfache rollenbasierte Policy: Nur die Rolle „admin" erhält Zugriff.',
    'ne.tpl.readWrite.title':  'Lesen für alle, Schreiben für Eigentümer',
    'ne.tpl.readWrite.desc':   '2-Regel-Policy: Alle dürfen lesen, nur Eigentümer dürfen schreiben.',
    'ne.tpl.timeBased.title':  'Zeitbasierter Zugriff',
    ...
    'ne.toolbar.download':     'Policy herunterladen',
    'ne.toolbar.tidy':         'Nodes automatisch anordnen',
    'ne.toolbar.clear':       'Canvas zurücksetzen',
    'ne.toolbar.clear.confirm': 'Canvas zurücksetzen und alle Nodes löschen?',
    'ne.node.delete.confirm.text': 'Node wirklich löschen?',
    'ne.node.delete.confirm.yes':  'Löschen',
    'ne.node.delete.confirm.no':   'Abbrechen',
    ...
    // ── Simulator (Phase 3) ──
    'sim.tab.evaluate':          'Simulator',
    'sim.tab.history':           'Verlauf',
    'sim.tab.tests':             'Testfälle',
    'sim.mode.simple':           'Einfach',
    'sim.mode.xml':              'XACML-XML',
    'sim.run':                   'Simulation starten',
    'sim.saveTest.btn':          '+ Als Testfall speichern',
    'sim.saveTest.title':        'Aktuellen Request als Testfall speichern',
    'sim.saveTest.namePrompt':   'Testfall-Name:',
    'sim.saveTest.expectedPrompt': 'Erwartetes Ergebnis (Permit / Deny / NotApplicable / Indeterminate):',
    'sim.field.role':            'Rolle (Subject)',
    'sim.field.role.ph':         'z.B. doctor',
    'sim.field.subjectId':       'Subject-ID',
    'sim.field.subjectId.ph':    'z.B. user-123',
    'sim.field.action':          'Aktion (Action)',
    'sim.field.action.ph':       'z.B. read',
    'sim.field.resource':        'Ressource (Resource)',
    'sim.field.resource.ph':     'z.B. patient-record-123',
    'sim.field.value':           'Wert',
    'sim.extra.add':             'Weiteres Attribut hinzufügen',
    'sim.extra.remove':          'Attribut entfernen',
    'sim.xml.label':             'XACML Request XML',
    'sim.xml.ph':                '<Request xmlns="urn:oasis:names:tc:xacml:3.0:core:schema:wd-17">\n  <Attributes Category="urn:oasis:names:tc:xacml:1.0:subject-category:access-subject">\n    <Attribute AttributeId="urn:oasis:names:tc:xacml:2.0:subject:role">\n      <AttributeValue DataType="string">doctor</AttributeValue>\n    </Attribute>\n  </Attributes>\n  ...\n</Request>',
    'sim.result.placeholder':    'Bitte einen Request eingeben und Simulation starten.',
    'sim.err.noPolicy':          'Keine Policy vorhanden. Bitte zuerst eine Policy im Editor erstellen.',
    'sim.err.xmlParse':          'XML-Fehler beim Parsen des Requests',
    'sim.decision.permit':       'PERMIT — Zugriff erlaubt',
    'sim.decision.deny':         'DENY — Zugriff verweigert',
    'sim.decision.notapplicable':'NOT APPLICABLE — Keine Regel trifft zu',
    'sim.decision.indeterminate':'INDETERMINATE — Auswertungsfehler',
    'sim.trace.title':           'Auswertung (Trace)',
    'sim.trace.alg':             'Algorithmus',
    'sim.trace.norules':         'Keine Regeln definiert.',
    'sim.trace.unnamed':         '(unbenannt)',
    'sim.trace.skipped':         'übersprungen',
    'sim.trace.target':          'Target',
    'sim.trace.targetMatch':     'trifft zu',
    'sim.trace.targetAll':       'gilt für alle',
    'sim.trace.targetMiss':      'trifft nicht zu',
    'sim.trace.conditions':      'Bedingungen',
    'sim.trace.condMatch':       'erfüllt',
    'sim.trace.condMiss':        'nicht erfüllt',
    'sim.check.noValue':         'kein Wert im Request',
    'sim.history.empty':         'Noch keine Requests ausgeführt.',
    'sim.history.title':         'Letzte Requests',
    'sim.history.clear':         'Verlauf löschen',
    'sim.history.replay':        'Erneut ausführen',
    'sim.tests.empty':           'Noch keine Testfälle gespeichert.',
    'sim.tests.title':           'Testfälle',
    'sim.tests.runAll':          'Alle ausführen',
    'sim.tests.delete':          'Testfall entfernen',
    'sim.tests.export':          'Exportieren',
    'sim.tests.import':          'Importieren',
    'sim.tests.importError':     'Import fehlgeschlagen: Ungültiges JSON-Format.',
    'sim.tests.edit':            'Testfall bearbeiten',
    'sim.edit.banner':           'Testfall wird bearbeitet: {name}',
    'sim.edit.save':             'Testfall aktualisieren',
    'sim.edit.cancel':           'Abbrechen',
    'sim.cond.title':            'Bedingungsattribute',
    'sim.cond.hint':             'Attributwerte für die Condition-Auswertung',
    'sim.cond.valuePh':          'Tatsächlicher Wert',
  ...
  en: {
    ...
    'ne.field.rule.desc':      'Description',
    'ne.field.rule.effect':    'Effect',
    ...
    'ne.adv.section':              'Advanced',
    'ne.adv.valueType':            'Value Type',
    ...
    'ne.node.note.label':      'Note',
    'ne.node.color':           'Change color',
    'ne.placeholder.note':     'Enter comment…',
    'ne.search.placeholder':   'Search…',
    'ne.search.title':         'Search node by name',
    'ne.share.title':          'Copy shareable link',
    'ne.minimap.title':        'Minimap — click to navigate',
    'ne.tpl.btn':              'Templates',
    'ne.tpl.btn.title':        'Load a pre-built policy template',
    'ne.tpl.modal.title':      'Choose a Policy Template',
    'ne.tpl.modal.close':      'Close',
    'ne.tpl.load':             'Load',
    'ne.tpl.confirm':          'Replace current canvas with this template?',
    'ne.tpl.adminOnly.title':  'Admins only',
    'ne.tpl.adminOnly.desc':   'Simple role-based policy: only the "admin" role gets access.',
    'ne.tpl.readWrite.title':  'Read for all, write for owner',
    'ne.tpl.readWrite.desc':   '2-rule policy: everyone can read, only owners can write.',
    'ne.tpl.timeBased.title':  'Time-based access',
    ...
    'ne.toolbar.download':     'Download policy',
    'ne.toolbar.tidy':         'Auto-arrange nodes',
    'ne.toolbar.clear':       'Reset canvas',
    'ne.toolbar.clear.confirm': 'Reset canvas and delete all nodes?',
    'ne.node.delete.confirm.text': 'Really delete this node?',
    'ne.node.delete.confirm.yes':  'Delete',
    'ne.node.delete.confirm.no':   'Cancel',
    ...
    // ── Simulator (Phase 3) ──
    'sim.tab.evaluate':          'Simulator',
    'sim.tab.history':           'History',
    'sim.tab.tests':             'Test Cases',
    'sim.mode.simple':           'Simple',
    'sim.mode.xml':              'XACML XML',
    'sim.run':                   'Run Simulation',
    'sim.saveTest.btn':          '+ Save as Test Case',
    'sim.saveTest.title':        'Save current request as test case',
    'sim.saveTest.namePrompt':   'Test case name:',
    'sim.saveTest.expectedPrompt': 'Expected result (Permit / Deny / NotApplicable / Indeterminate):',
    'sim.field.role':            'Role (Subject)',
    'sim.field.role.ph':         'e.g. doctor',
    'sim.field.subjectId':       'Subject ID',
    'sim.field.subjectId.ph':    'e.g. user-123',
    'sim.field.action':          'Action',
    'sim.field.action.ph':       'e.g. read',
    'sim.field.resource':        'Resource',
    'sim.field.resource.ph':     'e.g. patient-record-123',
    'sim.field.value':           'Value',
    'sim.extra.add':             'Add attribute',
    'sim.extra.remove':          'Remove attribute',
    'sim.xml.label':             'XACML Request XML',
    'sim.xml.ph':                '<Request xmlns="urn:oasis:names:tc:xacml:3.0:core:schema:wd-17">\n  <Attributes Category="urn:oasis:names:tc:xacml:1.0:subject-category:access-subject">\n    <Attribute AttributeId="urn:oasis:names:tc:xacml:2.0:subject:role">\n      <AttributeValue DataType="string">doctor</AttributeValue>\n    </Attribute>\n  </Attributes>\n  ...\n</Request>',
    'sim.result.placeholder':    'Enter a request and click Run Simulation.',
    'sim.err.noPolicy':          'No policy available. Please create a policy in the editor first.',
    'sim.err.xmlParse':          'XML parse error in request',
    'sim.decision.permit':       'PERMIT — Access allowed',
    'sim.decision.deny':         'DENY — Access denied',
    'sim.decision.notapplicable':'NOT APPLICABLE — No rule matched',
    'sim.decision.indeterminate':'INDETERMINATE — Evaluation error',
    'sim.trace.title':           'Evaluation Trace',
    'sim.trace.alg':             'Algorithm',
    'sim.trace.norules':         'No rules defined.',
    'sim.trace.unnamed':         '(unnamed)',
    'sim.trace.skipped':         'skipped',
    'sim.trace.target':          'Target',
    'sim.trace.targetMatch':     'matched',
    'sim.trace.targetAll':       'matches all',
    'sim.trace.targetMiss':      'not matched',
    'sim.trace.conditions':      'Conditions',
    'sim.trace.condMatch':       'satisfied',
    'sim.trace.condMiss':        'not satisfied',
    'sim.check.noValue':         'no value in request',
    'sim.history.empty':         'No requests run yet.',
    'sim.history.title':         'Recent Requests',
    'sim.history.clear':         'Clear history',
    'sim.history.replay':        'Run again',
    'sim.tests.empty':           'No test cases saved yet.',
    'sim.tests.title':           'Test Cases',
    'sim.tests.runAll':          'Run all',
    'sim.tests.delete':          'Delete test case',
    'sim.tests.export':          'Export',
    'sim.tests.import':          'Import',
    'sim.tests.importError':     'Import failed: Invalid JSON format.',
    'sim.tests.edit':            'Edit test case',
    'sim.edit.banner':           'Editing test case: {name}',
    'sim.edit.save':             'Update test case',
    'sim.edit.cancel':           'Cancel',
    'sim.cond.title':            'Condition Attributes',
    'sim.cond.hint':             'Attribute values for condition evaluation',
    'sim.cond.valuePh':          'Actual value',
