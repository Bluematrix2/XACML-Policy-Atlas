...
const TRANSLATIONS = {
  de: {
    ...
    'ne.subject.group':        'Gruppe',
    'ne.subject.email':        'E-Mail',
    'ne.field.operator':       'Operator',
    'ne.op.eq':                'ist',
    'ne.op.neq':               'ist nicht',
    'ne.op.contains':          'enthält',
    'ne.op.startsWith':        'beginnt mit',
    'ne.op.inList':            'in Liste',
    'ne.field.value':          'Wert',
    'ne.placeholder.subject':  'z.B. doctor',
    'ne.field.action':         'Aktion',
    ...
    'ne.field.action.custom':  'Benutzerdefinierte Aktion',
    'ne.field.resource.type':  'Ressource-Typ',
    'ne.resource.document':    'Dokument',
    'ne.resource.endpoint':    'Endpoint',
    'ne.resource.service':     'Service',
    'ne.resource.custom':      'Benutzerdefiniert',
    'ne.field.resource.id':    'Identifier',
    'ne.placeholder.resource': 'z.B. patient-record',
    'ne.field.resource.wildcard': 'Alle Ressourcen dieses Typs',
    'ne.field.condition.attr': 'Attribut',
    'ne.placeholder.condition': 'z.B. department',
  ...
  en: {
    ...
    'ne.subject.group':        'Group',
    'ne.subject.email':        'E-Mail',
    'ne.field.operator':       'Operator',
    'ne.op.eq':                'is',
    'ne.op.neq':               'is not',
    'ne.op.contains':          'contains',
    'ne.op.startsWith':        'starts with',
    'ne.op.inList':            'in list',
    'ne.field.value':          'Value',
    'ne.placeholder.subject':  'e.g. doctor',
    'ne.field.action':         'Action',
    'ne.action.read':          'Read',
    ...
    'ne.field.action.custom':  'Custom Action',
    'ne.field.resource.type':  'Resource Type',
    'ne.resource.document':    'Document',
    'ne.resource.endpoint':    'Endpoint',
    'ne.resource.service':     'Service',
    'ne.resource.custom':      'Custom',
    'ne.field.resource.id':    'Identifier',
    'ne.placeholder.resource': 'e.g. patient-record',
    'ne.field.resource.wildcard': 'All resources of this type',
    'ne.field.condition.attr': 'Attribute',
    'ne.placeholder.condition': 'e.g. department',
